...
public class BackgroundControl_0 : MonoBehaviour
{
    ...
    [Header("Auto Background Change")]
    public float changeInterval = 30f; // 5초마다 배경 변경
    void Start()
    {
        ...
        // 일정 시간마다 NextBG() 자동 호출
        InvokeRepeating(nameof(NextBG), changeInterval, changeInterval);
    }
